...
def predict_with_model(options):
    ...
    for i, input_audio in enumerate(options['input_audio']):
        ...
        # for key in model.instruments.keys():
        #     print(key)
...
"""
Example:
    python3 inference.py --input_audio lshs.mp3 --output_folder ./results/ --cuda --overlap_large 0.25 --overlap_small 0.25 --chunk_size 500000
"""
