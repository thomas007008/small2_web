...
class EnsembleDemucsMDXMusicSeparationModelLowGPU:
    ...
    def separate_music_file(
        ...
        separated_music_arrays['guitar'] = guitar
        output_sample_rates['guitar'] = sample_rate

        separated_music_arrays['piano'] = piano
...
if __name__ == '__main__':
    ...
    m.add_argument("--input_audio", default=['/home//workspace/music_site/music_app/algo/MVSEP_MDX23/yddqz.wav'],nargs='+', type=str, help="Input audio location. You can provide multiple files at once")
    m.add_argument("--output_folder", default='/home//workspace/music_site/music_app/algo/MVSEP_MDX23/results',type=str, help="Output audio folder")
