...
from pytorch_utils import move_data_to_device,move_data
...
def train(args):
    ...
    for batch_data_dict in train_loader:
        ...
        batch_waveform = torch.Tensor(batch_data_dict['waveform'])
...
if __name__ == '__main__':
    ...
    parser_train.add_argument(
        '--workspace', type=str, default="/root/yyz/code/piano_transcription")
    parser_train.add_argument('--model_type', type=str,
                              default="Regress_onset_offset_frame_velocity_CRNN")
    parser_train.add_argument('--loss_type', type=str,
                              default="regress_onset_offset_frame_velocity_bce")
    parser_train.add_argument(
        '--augmentation', type=str, default='none', choices=['none', 'aug'])
    parser_train.add_argument('--max_note_shift', type=int, default=0)
    parser_train.add_argument('--batch_size', type=int, default=16)
    parser_train.add_argument('--learning_rate', type=float, default=1e-3)
    parser_train.add_argument('--reduce_iteration', type=int, default=2000)
    parser_train.add_argument('--load_permodel', type=int,  default=0)
    parser_train.add_argument('--resume_iteration', type=int,  default=0)
    parser_train.add_argument('--early_stop', type=int, default=100000)
    parser_train.add_argument(
        # '--mini_data', action='store_true', default=True)
