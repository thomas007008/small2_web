...
from utilities import (create_folder, float32_to_int16, create_logging, 
    get_filename, read_metadata, read_midi, read_midi_new, read_maps_midi)
import config
...
def pack_maestro_dataset_to_hdf5(args):
    ...
    # Paths
    csv_path = os.path.join(dataset_dir, 'data_vocal.csv')
    ...
    for n in range(audios_num):
        ...
        midi_dict = read_midi_new(midi_path,tempo_list)
        # Load audio
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--mode', type=str, default="pack_maestro_dataset_to_hdf5", help='Directory of dataset.')
    parser.add_argument(
        '--dataset_dir', type=str, default="/root/yyz/YYZ/data/data_vocal1", help='Directory of dataset.')
    parser.add_argument(
        '--workspace', type=str, default="/root/yyz/code/piano_transcription", help='Directory of your workspace.')

    # parser_pack_maps = subparsers.add_parser('pack_maps_dataset_to_hdf5')
    # parser_pack_maps.add_argument(
    #     '--dataset_dir', type=str, default="/home/ubuntujt6/Data/yyz_workspace/data/AI_Music", help='Directory of dataset.')
    # parser_pack_maps.add_argument(
    #     '--workspace', type=str, default="/home/ubuntujt6/Data/yyz_workspace/code/ai_music/piano_transcription", help='Directory of your workspace.')
